---
description: "WMS 场景路由入口：识别功能开发、排障、Review、数据库变更、重构或文档任务，并结合统一场景目录推荐下一步阶段入口"
---
...
3. 专项检查点必须来自 scene-catalog 中对应章节，而不是临场自由发挥
4. 若边界不清或命中高风险条件，下一步必须推荐 /wms-plan-gate；若改动已存在则优先推荐 /wms-evaluation-gate；若目标是确认真实链路，则优先推荐 /wms-link-trace
